using BitIosPwaSplashTest.Client.Core;
#if BlazorElectron
...
namespace BitIosPwaSplashTest.Client.Web;
...
public class Program
{
    ...
    public static WebAssemblyHost CreateHostBuilder(string[] args)
    {
        ...
        builder.Configuration.AddJsonStream(typeof(MainLayout).Assembly.GetManifestResourceStream("BitIosPwaSplashTest.Client.Core.appsettings.json"));
